...
- Chinese operations are `:crawl:validateChineseDictionaries`, `:crawl:dryRunChineseLocalizedNames`, `:crawl:produceChineseReviewReport`, `:crawl:generateChineseLocalizedNames`, `:crawl:chineseGoldenTest`, and `:crawl:reindexChineseFields`. See [`docs/development/chinese-localization.md`](../docs/development/chinese-localization.md).
