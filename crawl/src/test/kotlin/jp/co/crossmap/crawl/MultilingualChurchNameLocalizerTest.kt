...
class MultilingualChurchNameLocalizerTest {
    ...
    fun catholicChurchNameOmitsRedundantJapanQualifierInEveryLanguage() {
        ...
        assertEquals(
            setOf("ja", "en", "ko", "pt", "id", "vi", "zh-Hans", "zh-Hant"),
    ...
    fun composesUccjAkabaneIntoEnglishAndKoreanProgrammatically() {
        ...
        assertEquals(setOf("ja", "en", "ko", "pt", "id", "vi", "zh-Hans", "zh-Hant"), result.localizedNames.map { it.languageCode }.toSet())
    ...
    fun improvesRealPortugueseGoogleTitlesWithReviewedPhrasesGeonamesAndAcronyms() {
        ...
        assertEquals(setOf("ja", "en", "ko", "pt", "id", "vi", "zh-Hans", "zh-Hant"), composed.localizedNames.map { it.languageCode }.toSet())
    ...
    fun reviewedEnglishAndSpanishPhrasesAvoidIcuWholeWordArtifacts() {
        ...
        assertEquals(
            setOf("ja", "en", "ko", "pt", "id", "vi", "es", "zh-Hans", "zh-Hant"),
